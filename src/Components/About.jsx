...
function About() {
  return (
    <section id='about' className='bg-violet-200  '>
       ...
       className=''>
            <img src="" alt="image kara" srcset="" />
            <p> I am a full stack developer, but I specialize more on front end development. I thrive on creating a user-friendly and visually appealing websites. What really excite me is the opportunity to solve real world problems through web development.
            </p>
        </motion.div>
